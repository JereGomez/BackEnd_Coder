...
apiProd.get ('' , async (req,res)=>{
    ...
    //res.render('partials/productosHBS.hbs', {prod: true, productos }); //handlebars
    //res.render('partials/productosEJS.ejs' , {productos}) //EJS
    console.log(productos)
    res.render('partials/productosPUG', {productos: productos}); //PUG
});
